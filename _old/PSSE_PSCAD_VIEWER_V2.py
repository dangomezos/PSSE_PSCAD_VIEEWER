...
class PlotCanvas(QWidget):
    def __init__(self, get_file_list_callback):
        ...
        layout = QHBoxLayout(self)  # Horizontal para colocar botón a la derecha
    ...
    def on_mouse_drag(self, event):
        ...
        # Código anterior de zoom con arrastre
